...
<body>
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <x-nav-link href="/posts" :active="request()->is('posts')" >Blog Posts</x-nav-link>
                </div>
            </div> 
            </div>
            <div class="hidden md:block">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <div class="ml-3">
                <div class="text-base/5 font-medium text-white">Qwuaku Lawrence</div>
    ...
    <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
         <!-- Slot content appears here -->
          <!-- the slot object that enables dynamic ontent display -->
          {{ $slot }}
        </div>
    </main>
    </div>
